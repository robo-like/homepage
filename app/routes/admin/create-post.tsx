...
import type { Route } from "./+types/admin/create-post";
        ...
        <Container className="mt-10">
            ...
            <Card>
                <Form method="post" className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    {/* TODO: Integrate TipTap editor here for the body content */}
                    <div className="flex flex-col gap-1">
                        ...
                        <textarea
                            name="body"
                            className="px-3 py-2 bg-white/5 border border-gray-700 rounded-lg min-h-[200px]"
                            required
                        />
                        {actionData?.errors?.body && (
                            <span className="text-sm text-red-500">{actionData.errors.body}</span>
                        )}
                    </div>
